...
#ifndef SWIFTSHADER_AGGRESSIVE_BATCHING
#	ifdef SWIFTSHADER_VK_AGGRESSIVE_BATCHING
#		define SWIFTSHADER_AGGRESSIVE_BATCHING SWIFTSHADER_VK_AGGRESSIVE_BATCHING
#	else
#		define SWIFTSHADER_AGGRESSIVE_BATCHING 0
#	endif
#endif
